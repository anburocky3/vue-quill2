...
;(() => {
  ...
  files.forEach((shortName) => {
    ...
    const name = `anburocky3/${shortName}`
    ...
    if (args.force || !pkgExists) {
      const json = {
        ...
        license: 'MIT',
        bugs: {
          url: 'https://github.com/anburocky3/vue-quill2/issues',
        },
        homepage: `https://github.com/anburocky3/vue-quill2/tree/dev/packages/${shortName}#readme`,
      }
