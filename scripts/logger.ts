...
// // Test logger
// header(['vue-quill2', 'file-size', 'file-size', 'file-size'], 'THIS IS MY MESSA')
// success(['vue-quill2', 'file-size'], `File assets input doesn't exist right now`)
// error(['vue-quill2', 'file-size'], `File assets input doesn't exist right now`)
// warning(['vue-quill2', 'file-size'], `File assets input doesn't exist right now`)
// info(['vue-quill2', 'file-size'], `File assets input doesn't exist right now`)
// debug(['vue-quill2', 'file-size'], `File assets input doesn't exist right now`)
// list('vue-quill2', 'Build Output', [
