...
const ogImage = 'https://vueup.github.io/vue-quill2/og-image.png'
const ogTitle = 'VueQuill'
const ogUrl = 'https://vueup.github.io/vue-quill2/'
...
export default defineConfig({
  ...
  head: [
    [
      'link',
      { rel: 'icon', type: 'image/svg+xml', href: '/vue-quill2/logo.svg' },
    ],
  ...
  themeConfig: {
    ...
    editLink: {
      pattern:
        'https://github.com/anburocky3/vue-quill2/edit/beta/docs/content/:path',
      text: 'Edit this page on GitHub',
    },

    socialLinks: [
      { icon: 'github', link: 'https://github.com/anburocky3/vue-quill2' },
    ],

    algolia: {
      appId: process.env.ALGOLIA_APP_ID as string,
      apiKey: process.env.ALGOLIA_SEARCH_KEY as string,
      indexName: 'vue-quill2',
      searchParameters: {},
    },
